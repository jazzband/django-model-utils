...
class ChoicesTests(TestCase):
    ...
    def test_iteration(self):
        self.assertEqual(
            tuple(self.STATUS), (("DRAFT", "DRAFT"), ("PUBLISHED", "PUBLISHED"))
        )

    def test_reversed(self):
        self.assertEqual(
            tuple(reversed(self.STATUS)),
    ...
    def test_deepcopy(self):
        ...
        self.assertEqual(list(self.STATUS), list(copy.deepcopy(self.STATUS)))
...
class LabelChoicesTests(ChoicesTests):
    ...
    def test_inequality(self):
        self.assertNotEqual(
            self.STATUS,
            [("DRAFT", "is draft"), ("PUBLISHED", "is published"), "DELETED"],
        )
        self.assertNotEqual(self.STATUS, Choices("DRAFT"))
    ...
    def test_composability(self):
        self.assertEqual(
            ...
            + Choices(("PUBLISHED", "is published"), "DELETED"),
            self.STATUS,
        )
        ...
        self.assertEqual(
            ...
            + (("PUBLISHED", "is published"), "DELETED"),
            self.STATUS,
        )

    def test_option_groups(self):
        c = Choices(("group a", [(1, "one"), (2, "two")]), ["group b", ((3, "three"),)])
        self.assertEqual(
            list(c),
            [
                ("group a", [(1, "one"), (2, "two")]),
...
class IdentifierChoicesTests(ChoicesTests):
    ...
    def test_composability(self):
        self.assertEqual(
            Choices((0, "DRAFT", "is draft"), (1, "PUBLISHED", "is published"))
            + Choices(
                (2, "DELETED", "is deleted"),
            ),
            self.STATUS,
        ...
        self.assertEqual(
            ((0, "DRAFT", "is draft"), (1, "PUBLISHED", "is published"))
            + Choices(
                (2, "DELETED", "is deleted"),
            ),
            self.STATUS,
